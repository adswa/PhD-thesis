...
\begin{figure}
	...
	\begin{subfigure}{0.32\textwidth}
		...
		\caption{$k$=20}
	\end{subfigure}
	\caption[Time point by time point correlation distances in shared spaces]{Time point by time point correlation distances in shared spaces build from the entire trial, across epochs with different stimulus types, for different values of $k$. Notable events in the trial, such as the first visual presentation (0-700ms), the delay phase (700-2700ms) or the second visual presentation (2700-3400ms) seem to visible from the time-point to time-point correlation distances.}
