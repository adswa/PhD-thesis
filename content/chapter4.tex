...
Next, data were first low-pass filtered with a 100Hz lowpass filter to constrain it into a frequency range of interest (firwin method, Hamming window with 0.0194 passband ripple and 53 dB stopband attenuation, an upper passband edge of 100.00 Hz, an upper transition bandwidth of 25.00 Hz (-6 dB cutoff frequency: 112.50 Hz), and a filter length: 133 samples (0.133 s)).
