...
An inspection of average reaction times per subject revealed a small subset slow participants with average reaction times exceeding 1.3s (Figures \ref{fig:avgreactions}, \ref{fig:avgreactionsnobrain}).
...
I assessed their relative influence on choice via a cross-validated logistic regression analysis.
