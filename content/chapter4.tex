...
This section introduces relevant concepts, and summarizes common elements across analysis to avoid repetition.
...
A transformer common to all pipelines was a \texttt{StandardScaler()}, transforming data to have zero mean and unit variance.
