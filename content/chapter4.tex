...
Finally, data were low-pass filtered with a 100 ... TODO
...
For one subject, however, both EOG and ECG channel were flat, and components were manually selected.



The ICA was then fit on data split into epochs of 3 seconds
